...
?>
            ...
            <div class="row gx-5">
                <div class="col-lg-4 col-md-6 footer-about">
                    <div class="d-flex flex-column align-items-center justify-content-center text-center h-100 bg-primary p-4">
                        ...
                        <form action="">
                        <?php echo do_shortcode('[contact-form-7 id="195" title="contact form 2"]');?>
                        </form>
                    </div>
                </div>
    ...
    <!-- Back to Top -->
    <a href="#" class="btn btn-lg btn-primary btn-lg-square rounded back-to-top"><i class="fas fa-arrow-up text-white"></i></a>
