<div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container py-5">
            <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
                <h5 class="fw-bold text-primary text-uppercase"><?php the_field('blog_subtitle','option');?></h5>
                <h1 class="mb-0"><?php the_field('blog_title','option');?></h1>
            </div>
            <div class="row g-5">
                <?php 
                $args=array(
                ...
                if($query->have_posts()){
                    ...
                    <div class="blog-item bg-light rounded overflow-hidden">
                        <div class="blog-img position-relative overflow-hidden">
                            ...
                            <a class="position-absolute top-0 start-0 bg-primary text-white rounded-end mt-5 py-2 px-4" href=""><?php echo $cat[0]->name?></a>
                        </div>
                        <div class="p-4">
